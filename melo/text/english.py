...
CMU_DICT_PATH = os.path.join(current_file_path, "language_cmudict/cmudict.rep")
CACHE_PATH = os.path.join(current_file_path, "language_cmudict/cmudict_cache.pickle")
_g2p = G2p()
